...
import { Plus, Search, Edit, Trash2, Plane, Calendar, Users, MapPin } from "lucide-react"
...
// Real world airports and locations
const AIRPORTS = [
  // Kenyan Airports
...
// Realistic flight times based on routes
...
// Realistic pricing in KSH based on route distance and class
...
export function FlightsManagement() {
  ...
  const [newFlight, setNewFlight] = useState({
    ...
    time: "",
    capacity: "",
    status: "On Time" as Flight["status"],
  })
  ...
  const handleAddFlight = () => {
    if (
      ...
      // Add new flight to the beginning of the list for immediate visibility
      ...
      console.log("Flight added successfully:", flight.flightNumber)
    }
  }
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-8">
      ...
      >
        <div>
          ...
          <p className="text-gray-600">Manage your airline fleet operations</p>
        </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setNewFlight({ ...newFlight, status: value as Flight["status"] })}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <Select
                              value={newFlight.status}
                              onValueChange={(value) =>
                                setNewFlight({ ...newFlight, status: value as Flight["status"] })
                              }
                            >
                              <SelectTrigger>
                                <SelectValue />
